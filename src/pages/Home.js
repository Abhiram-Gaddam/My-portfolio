...
>       
          ...
          viewport={{ once: true, amount: 0.2 }} className=' bg-blue-300 pl-5 rounded-tr-lg flex justify-center items-center md:h-2/5 h-full md:py-0 py-3 mt-10 rounded-bl-full  rounded-tl-full ' > So! This is me Abhiram a Junior Front end Developer making mistakes while creating Magic.. 
          </motion.div>
          ...
          < motion.div initial={{ opacity: 0, x: 0 }}
            ...
            viewport={{ once: true, amount: 0.2 }} className=' bg-blue-300 pl-5 rounded-l-lg flex justify-center items-center md:h-2/5 h-3/6  md:py-0 py-2 mt-40 rounded-br-full  rounded-tr-full ' > So! This is me Abhiram a Junior Front end Developer making mistakes while creating Magic.. 
            </motion.div>
           </div>
